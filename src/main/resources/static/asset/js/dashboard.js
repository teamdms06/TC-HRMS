...
//        var valDataList1 = [];
        ...
        if ($("#visit-sale-chart").length) {
            var val12 = $('#countKeyVal').val();
            var finalString = val12.slice(1, -1);
            var valDataList1 = finalString.split(",");
            var allApplicationList = $('#countAllApplication').val().slice(1, -1).split(",");
            var selectedList = $('#countSelected').val().slice(1, -1).split(",");
            var rejectedList = $('#countRejected').val().slice(1, -1).split(",");



//            $('#countKeyVal').each(function () {
//
//                valDataList1.push(this.value);
//
//            });
            Chart.defaults.global.legend.labels.usePointStyle = true;
        ...
        if ($("#traffic-chart").length) {
            ...
            gradientStrokeYellow.addColorStop(0, 'rgba(255, 236, 139, 1)');
            gradientStrokeYellow.addColorStop(1, 'rgba(255, 236, 139, 1)');
            var gradientLegendYellow = 'linear-gradient(to right, rgba(255, 236, 139, 1), rgba(255, 255, 126, 1))';

            var gradientStrokePurple = ctx.createLinearGradient(0, 0, 0, 120);
            gradientStrokePurple.addColorStop(0, 'rgba(90, 34, 139, 1)');
            gradientStrokePurple.addColorStop(1, 'rgba(191, 85, 236, 1)');
            var gradientLegendPurple = 'linear-gradient(to right, rgba(90, 34, 139, 1), rgba(191, 85, 236, 1))';
            var overAllperData = $('#overAllperData').val().slice(1, -1).split(",");
